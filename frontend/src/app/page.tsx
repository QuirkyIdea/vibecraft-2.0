...
import DraftRefinementPanel from "@/components/panels/DraftRefinementPanel";
import ConferenceRecommendPanel from "@/components/panels/ConferenceRecommendPanel";
import SimilarityScanPanel from "@/components/panels/SimilarityScanPanel";
import { useAuth } from "@/context/AuthContext";
import { useProjects } from "@/context/ProjectContext";
import styles from "./page.module.css";

export type PanelType = "dashboard" | "projects" | "project_detail" | "antigravity" | "idea" | "patent" | "research" | "knowledge" | "roadmap" | "pipeline" | "draft_refine" | "conference" | "similarity_scan";
...
export default function Home() {
  ...
  const renderPanel = () => {
    switch (activePanel) {
      ...
      case "draft_refine":
        return <DraftRefinementPanel />;
      case "conference":
        return <ConferenceRecommendPanel />;
      case "similarity_scan":
        return <SimilarityScanPanel />;
      default:
        return <DashboardOverview />;
    }
  };
