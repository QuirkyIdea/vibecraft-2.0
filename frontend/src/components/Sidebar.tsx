...
const draftNavItems = [
    { id: "draft_refine" as PanelType, label: "Draft Refinement", icon: FileEdit },
    { id: "conference" as PanelType, label: "Conference Finder", icon: GraduationCap },
];
...
const toolNavItems = [
    ...
    { id: "similarity_scan" as PanelType, label: "Similarity Scan", icon: Microscope },
];
    ...
    return (
        <aside className={styles.sidebar}>
            <nav className={styles.nav}>
                ...
                {/* Draft & Conference Reference */}
                <div className={styles.navSection}>
                    <span className={styles.sectionLabel}>Draft & Conference</span>
