...
from app.api.routes import analysis, research, patent, knowledge, upload, auth, projects, antigravity, draft_conference
...
router.include_router(draft_conference.router, prefix="/draft-conference", tags=["Draft & Conference"])
